...
func callback(reachability:SCNetworkReachability, flags: SCNetworkReachabilityFlags, info: UnsafeMutableRawPointer?) {
    ...
    let reachability = Unmanaged<ReachabilityYYY>.fromOpaque(info).takeUnretainedValue()
    reachability.reachabilityChanged()
}

public class ReachabilityYYY {
    //向外提供静态使用
    static let shared = ReachabilityYYY()
    
    public typealias NetworkReachable = (ReachabilityYYY) -> ()
    public typealias NetworkUnreachable = (ReachabilityYYY) -> ()
...
public extension ReachabilityYYY {
    ...
    func startNotifier() throws {
        ...
        context.info = UnsafeMutableRawPointer(Unmanaged<ReachabilityYYY>.passUnretained(self).toOpaque())
...
fileprivate extension ReachabilityYYY {
